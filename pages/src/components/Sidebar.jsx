...
const Sidebar = ({ onLogout, userType }) => {
    ...
    const menuConfig = {
        ...
        profissionais: [
            ...
            { text: 'Pacientes', icon: <Users size={22} />, path: '/dashboard/pacientes' },
        ...
        usuarios_cnpj: [
            ...
            { text: 'Corpo Clínico', icon: <Stethoscope size={22} />, path: '/dashboard/profissionais' },
            { text: 'Unidades', icon: <Building2 size={22} />, path: '/dashboard/unidades' },
